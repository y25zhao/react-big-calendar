...
var Calendar = (function(_React$Component) {
  ...
  Calendar.prototype.getContext = function getContext(_ref2) {
    var startAccessor = _ref2.startAccessor,
      ...
      statusAccessor = _ref2.statusAccessor,
      ...
      formats = _ref2$formats === undefined ? {} : _ref2$formats

    var names = viewNames(views)
    var msgs = (0, _messages2.default)(messages)
    return {
      viewNames: names,
      ...
      getters: {
        eventProp: function eventProp() {
          return (
            (eventPropGetter && eventPropGetter.apply(undefined, arguments)) ||
            {}
          )
        },
        slotProp: function slotProp() {
          return (
            (slotPropGetter && slotPropGetter.apply(undefined, arguments)) || {}
          )
        },
        dayProp: function dayProp() {
          return (
            (dayPropGetter && dayPropGetter.apply(undefined, arguments)) || {}
          )
        },
      },
      components: (0, _defaults2.default)(
        components[view] || {},
        (0, _omit2.default)(components, names),
        {
          eventWrapper: _NoopWrapper2.default,
          eventContainerWrapper: _NoopWrapper2.default,
          dayWrapper: _NoopWrapper2.default,
          dateCellWrapper: _NoopWrapper2.default,
          weekWrapper: _NoopWrapper2.default,
          timeSlotWrapper: _NoopWrapper2.default,
        }
      ),
      accessors: {
        ...
        status: (0, _accessors.wrapAccessor)(statusAccessor),
  ...
  Calendar.prototype.render = function render() {
    ...
    var _state$context = this.state.context,
      accessors = _state$context.accessors,
      components = _state$context.components,
      getters = _state$context.getters,
      localizer = _state$context.localizer,
...
Calendar.propTypes = {
   ...
   */
  detailView: _propTypes2.default.object,
   ...
   */
  smallEventBoundary: _propTypes2.default.number,
  ...
  formats: _propTypes2.default.shape({
     ...
     *
     */
    currentTimeIndicatorFormat: _propTypes3.dateFormat,
     ...
     */
    timeGutterHeaderFormat: _propTypes3.dateFormat,
  ...
  components: _propTypes2.default.shape({
    ...
    eventContainerWrapper: _propTypes3.elementType,
    dayWrapper: _propTypes3.elementType,
    dateCellWrapper: _propTypes3.elementType,
    timeSlotWrapper: _propTypes3.elementType,
    timeGutterHeader: _propTypes3.elementType,
    popupHeader: _propTypes3.elementType,
    detailView: _propTypes3.elementType,
    ...
    day: _propTypes2.default.shape({
      ...
      event: _propTypes3.elementType,
      popupHeader: _propTypes3.elementType,
      allDayEvent: _propTypes3.elementType,
    }),
  ...
  messages: _propTypes2.default.shape({
    ...
    noEventsInRange: _propTypes2.default.node,
