...
DayColumn.propTypes = {
  ...
  parentSelector: _propTypes2.default.string,
  ...
  this.renderEvents = function() {
    ...
    return styledEvents.map(function(_ref, idx) {
      ...
      return _react2.default.createElement(
        ...
        (_React$createElement.smallEventBoundary = smallEventBoundary),
        (_React$createElement.parentSelector = parentSelector),
        (_React$createElement.continuesEarlier = continuesEarlier),
        (_React$createElement.continuesLater = continuesLater),
        (_React$createElement.isExpandable = isExpandable),
        ...
        (_React$createElement.onClick = function onClick(e) {
          _this2._select(event, e)
          _onClick && _onClick(event, e.target)
        }),
