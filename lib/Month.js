...
var MonthView = (function(_React$Component) {
  ...
  MonthView.prototype.renderOverlay = function renderOverlay() {
    var _ref2 = (this.state && this.state.overlay) || {},
  ...
  MonthView.prototype.renderDetailView = function renderDetailView() {
    var _ref3 = (this.state && this.state.detail) || {},
      event = _ref3.event,
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.hide = function(what) {
    return function() {
      return _this3.setState(function() {
        ...
        return (_ref6 = {}), (_ref6[what] = null), _ref6
      })
    }
  }
  ...
  this.readerDateHeading = function(_ref7) {
    var date = _ref7.date,
      className = _ref7.className,
      props = _objectWithoutProperties(_ref7, ['date', 'className'])
